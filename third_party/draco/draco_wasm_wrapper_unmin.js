...
$jscomp.getGlobal = function(d) {
  return 'undefined' != typeof window && window === d ?
      d :
      'undefined' != typeof global && null != global ? global : d
};
...
$jscomp.polyfill = function(d, k, f, v) {
  if (k) {
    ...
    v = f[d];
    k = k(v);
    k != v && null != k && $jscomp.defineProperty(f, d, {configurable: !0, writable: !0, value: k})
  }
};
...
$jscomp.polyfill('Promise', function(d) {
  ...
  function f(d) {
    return d instanceof h ? d : new h(function(q, f) {
      q(d)
    })
  }
  ...
  h.prototype.createResolveAndReject_ = function() {
    ...
    var f = this, h = !1;
    return {
      resolve: d(this.resolveTo_), reject: d(this.reject_)
    }
  };
  ...
  h.prototype.then = function(d, f) {
    ...
    var w, q, B = new h(function(d, f) {
                w = d;
                q = f
              });
    this.callWhenSettled_(k(d, w), k(f, q));
    return B
  };
  ...
  h.prototype.callWhenSettled_ = function(d, f) {
    ...
    var k = this;
    null == this.onSettledCallbacks_ ? ha.asyncExecute(h) :
  ...
  h.race = function(d) {
    return new h(function(h, k) {
      for (var w = $jscomp.makeIterator(d), q = w.next(); !q.done; q = w.next())
        f(q.value).callWhenSettled_(h, k)
    })
  };
  h.all = function(d) {
    var k = $jscomp.makeIterator(d), q = k.next();
    return q.done ? f([]) : new h(function(d, h) {
      function w(f) {
        return function(h) {
          v[f] = h;
          B--;
      ...
      var v = [], B = 0;
      do
        v.push(void 0), B++, f(q.value).callWhenSettled_(w(v.length - 1), h), q = k.next();
      while (!q.done)
    })
  };
  return h
...
var DracoDecoderModule = function(d) {
  ...
  function v(a, b) {
    ...
    if (128 > c) {
      for (; 0 < b;)
        c = String.fromCharCode.apply(String, V.subarray(a, a + Math.min(b, 1024))),
        e = e ? e + c : c, a += 1024, b -= 1024;
      return e
    }
    return h(V, a)
  }
  function h(a, b) {
    ...
    for (c = '';;) {
      ...
      if (e & 128) {
        var d = a[b++] & 63;
        if (192 == (e & 224))
          c += String.fromCharCode((e & 31) << 6 | d);
        else {
          var f = a[b++] & 63;
          if (224 == (e & 240))
            e = (e & 15) << 12 | d << 6 | f;
          ...
          65536 > e ? c += String.fromCharCode(e) :
  ...
  function B(e) {
    for (; 0 < e.length;) {
      ...
      if ('function' == typeof b)
        ...
        var c = b.func;
        'number' === typeof c ? void 0 === b.arg ? a.dynCall_v(c) : a.dynCall_vi(c, b.arg) :
  ...
  function la() {
    ...
    for (var d = 0; d < p.length; d++)
      if (p[d] && a.___cxa_can_catch(p[d], c, e))
        return e = E[e >> 2], b.adjusted = e, (sa(p[d]), e) | 0;
    e = E[e >> 2];
    return (sa(c), e) | 0
  }
  function Y(e, b) {
    u.varargs = b;
    try {
      var c = u.get(), p = u.get(), d = u.get();
      e = 0;
      Y.buffers || (Y.buffers = [null, [], []], Y.printChar = function(b, c) {
        var e = Y.buffers[b];
        f(e);
        0 === c || 10 === c ? ((1 === b ? a.print : a.printErr)(h(e, 0)), e.length = 0) : e.push(c)
      });
      for (b = 0; b < d; b++) {
        for (var g = E[p + 8 * b >> 2], k = E[p + (8 * b + 4) >> 2], l = 0; l < k; l++)
          Y.printChar(c, V[g + l]);
        e += k
      }
      return e
  ...
  function ma(e, b) {
    ma.seen || (ma.seen = {});
    e in ma.seen || (a.dynCall_v(b), ma.seen[e] = 1)
  }
  function na(a) {
  ...
  function wa(e) {
    ...
    if (!(0 < da)) {
      ...
      B(Pa);
      0 < da || a.calledRun || (a.setStatus ? (a.setStatus('Running...'), setTimeout(function() {
                                                 setTimeout(function() {
                                                   a.setStatus('')
                                                 }, 1);
                                                 b()
    ...
    if ('string' === typeof a) {
      for (var b = 0, c = 0; c < a.length; ++c) {
        ...
        127 >= e ? ++b :
                   b = 2047 >= e ?
                   b + 2 :
                   65535 >= e ? b + 3 : 2097151 >= e ? b + 4 : 67108863 >= e ? b + 5 : b + 6
      }
      b = Array(b + 1);
      c = 0;
      e = b.length;
  ...
  a.isVersionSupported = function(a) {
    ...
    return 2 > a.length || 3 < a.length ?
        !1 :
        1 == a[0] && 0 <= a[1] && 3 >= a[1] ? !0 : 0 != a[0] || 10 < a[1] ? !1 : !0
  };
  var pa = {}, Z;
  for (Z in a) a.hasOwnProperty(Z) && (pa[Z] = a[Z]);
  a.arguments = [];
  ...
  if (a.ENVIRONMENT)
    ...
    ja = 'object' === typeof window, fa = 'function' === typeof importScripts,
  ...
  if (qa) {
    ...
    'undefined' != typeof read &&
        ...
        'function' === typeof quit && (a.quit = function(a, b) {
          quit(a)
        });
  else if (ja || fa)
    a.read = function(a) {
  ...
  a.print = 'undefined' !== typeof console ? console.log.bind(console) :
                                             'undefined' !== typeof print ? print : null;
  a.printErr = 'undefined' !== typeof printErr ?
      printErr :
      'undefined' !== typeof console && console.warn.bind(console) || a.print;
  a.print = a.print;
  a.printErr = a.printErr;
  for (Z in pa) pa.hasOwnProperty(Z) && (a[Z] = pa[Z]);
  pa = void 0;
  var oa = 0, Ia = 'undefined' !== typeof TextDecoder ? new TextDecoder('utf8') : void 0;
  'undefined' !== typeof TextDecoder && new TextDecoder('utf-16le');
  var ia, V, Ja, E, aa, Ca, ta, ua, Da, ka;
  var Ea = aa = Ca = ta = ua = Da = ka = 0;
  var Sa = !1;
  a.reallocBuffer || (a.reallocBuffer = function(a) {
    try {
      if (ArrayBuffer.transfer)
        var b = ArrayBuffer.transfer(D, a);
      else {
        var c = ia;
        b = new ArrayBuffer(a);
  ...
  var Fa = a.TOTAL_STACK || 5242880, A = a.TOTAL_MEMORY || 16777216;
  A < Fa &&
      a.printErr(
  ...
  var Pa = [], Ma = [], Na = [], ob = [], Oa = [], La = !1, pb = Math.floor, da = 0, Ga = null,
      ra = null;
  a.preloadedImages = {};
  a.preloadedAudios = {};
  (function() {
    ...
    function c(c, e, d) {
      function p(b, c) {
        ...
        k.memory &&
            (b = k.memory, c = a.buffer,
             ...
             c = new Int8Array(c), (new Int8Array(b)).set(c), a.buffer = D = b, q());
        a.asm = k;
        a.usingWasm = !0;
        da--;
        a.monitorRunDependencies && a.monitorRunDependencies(da);
        0 == da && (null !== Ga && (clearInterval(Ga), Ga = null), ra && (b = ra, ra = null, b()))
      }
      function g(a) {
      ...
      a.wasmBinary || 'function' !== typeof WebAssembly.instantiateStreaming || X(f) ||
    ...
    'function' === typeof a.locateFile &&
        (X(d) || (d = a.locateFile(d)), X(f) || (f = a.locateFile(f)),
         X(g) || (g = a.locateFile(g)));
    var h = {
      global: null,
      env: null,
      asm2wasm: {
    ...
    a.reallocBuffer = function(b) {
      if ('asmjs' === m)
        ...
        a: {
          b = ha(b, a.usingWasm ? 65536 : 16777216); var e = a.buffer.byteLength;
          if (a.usingWasm) try {
    ...
    a.asm = function(b, e, d) {
      if (!e.table) {
        ...
        e.table = 'object' === typeof WebAssembly && 'function' === typeof WebAssembly.Table ?
            void 0 !== f ? new WebAssembly.Table({initial: p, maximum: f, element: 'anyfunc'}) :
      ...
      (b = c(b, e, d)) ||
          O('no binaryen method succeeded. consider enabling more options, like interpreting, if you want that: https://github.com/kripken/emscripten/wiki/WebAssembly#binaryen-methods');
      return b
    }
  })();
  Ea = 1024;
  ...
  var y = {
    ...
    decRef: function(e) {
      if (e) {
        ...
        f(0 < b.refcount);
        b.refcount--;
        0 !== b.refcount || b.rethrown ||
            (b.destructor && a.dynCall_vi(b.destructor, e), delete y.infos[e],
  ...
  a.asmLibraryArg = {
    ...
    enlargeMemory:
        function() {
          var e = a.usingWasm ? 65536 : 16777216, b = 2147483648 - e;
          if (E[ka >> 2] > b) return !1;
          var c = A;
          for (A = Math.max(A, 16777216); A < E[ka >> 2];)
            A = 536870912 >= A ? ha(2 * A, e) : Math.min(ha((3 * A + 2147483648) / 4, e), b);
          e = a.reallocBuffer(A);
    ...
    ___cxa_throw:
        function(a, b, c) {
          y.infos[a] =
              {ptr: a, adjusted: a, type: b, destructor: c, refcount: 0, caught: !1, rethrown: !1};
          y.last = a;
    ...
    ___syscall140:
        function(a, b) {
          ...
          try {
            ...
            u.get();
            var d = u.get(), e = u.get(), f = u.get();
            FS.llseek(c, d, f);
            E[e >> 2] = c.position;
            c.getdents && 0 === d && 0 === f && (c.getdents = null);
            return 0
          } catch (ba) {
            return 'undefined' !== typeof FS && ba instanceof FS.ErrnoError || O(ba), -ba.errno
          }
        },
    ___syscall146: Y,
    ___syscall54:
  ...
  var $a = a._emscripten_bind_AttributeOctahedronTransform_AttributeOctahedronTransform_0 =
          function() {
    return a.asm._emscripten_bind_AttributeOctahedronTransform_AttributeOctahedronTransform_0.apply(
        null, arguments)
  },
      sb = a._emscripten_bind_AttributeOctahedronTransform_InitFromAttribute_1 =
          function() {
      ...
      cb = a._emscripten_bind_AttributeQuantizationTransform_AttributeQuantizationTransform_0 =
          function() {
        return a.asm
            ._emscripten_bind_AttributeQuantizationTransform_AttributeQuantizationTransform_0.apply(
                null, arguments)
      },
      ...
      wb = a._emscripten_bind_AttributeQuantizationTransform___destroy___0 =
          function() {
        return a.asm._emscripten_bind_AttributeQuantizationTransform___destroy___0.apply(
            null, arguments)
      },
      xb = a._emscripten_bind_AttributeQuantizationTransform_min_value_1 =
          function() {
        return a.asm._emscripten_bind_AttributeQuantizationTransform_min_value_1.apply(
            null, arguments)
      },
      yb = a._emscripten_bind_AttributeQuantizationTransform_quantization_bits_0 =
          function() {
        return a.asm._emscripten_bind_AttributeQuantizationTransform_quantization_bits_0.apply(
            null, arguments)
      },
      zb = a._emscripten_bind_AttributeQuantizationTransform_range_0 =
          function() {
      ...
      Bb = a._emscripten_bind_AttributeTransformData_transform_type_0 =
          function() {
      ...
      Mb = a._emscripten_bind_Decoder_GetAttributeInt16ForAllPoints_3 =
          function() {
      ...
      Pb = a._emscripten_bind_Decoder_GetAttributeIntForAllPoints_3 =
          function() {
        return a.asm._emscripten_bind_Decoder_GetAttributeIntForAllPoints_3.apply(null, arguments)
      },
      Qb = a._emscripten_bind_Decoder_GetAttributeMetadata_2 =
          function() {
        return a.asm._emscripten_bind_Decoder_GetAttributeMetadata_2.apply(null, arguments)
      },
      Rb = a._emscripten_bind_Decoder_GetAttributeUInt16ForAllPoints_3 =
          function() {
      ...
      Tb = a._emscripten_bind_Decoder_GetAttributeUInt8ForAllPoints_3 =
          function() {
        return a.asm._emscripten_bind_Decoder_GetAttributeUInt8ForAllPoints_3.apply(null, arguments)
      },
      Ub = a._emscripten_bind_Decoder_GetAttribute_2 =
          function() {
      ...
      Xb = a._emscripten_bind_Decoder_GetMetadata_1 =
          function() {
      ...
      $b = a._emscripten_bind_Decoder___destroy___0 =
          function() {
      ...
      mc = a._emscripten_bind_DracoUInt16Array_GetValue_1 =
          function() {
      ...
      oc = a._emscripten_bind_DracoUInt16Array_size_0 =
          function() {
      ...
      kb = a._emscripten_bind_Mesh_Mesh_0 =
          function() {
        return a.asm._emscripten_bind_Mesh_Mesh_0.apply(null, arguments)
      },
      wc = a._emscripten_bind_Mesh___destroy___0 =
          function() {
      ...
      Ac = a._emscripten_bind_MetadataQuerier_GetDoubleEntry_2 =
          function() {
      ...
      Dc = a._emscripten_bind_MetadataQuerier_GetStringEntry_2 =
          function() {
      ...
      Gc = a._emscripten_bind_MetadataQuerier___destroy___0 =
          function() {
      ...
      Hc = a._emscripten_bind_Metadata___destroy___0 =
          function() {
      ...
      ab = a._emscripten_bind_PointAttribute_PointAttribute_0 =
          function() {
      ...
      Kc = a._emscripten_bind_PointAttribute_attribute_type_0 =
          function() {
      ...
      $c = a._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_INVALID_TRANSFORM =
          function() {
        return a.asm._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_INVALID_TRANSFORM
      ...
      bd = a._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_OCTAHEDRON_TRANSFORM =
          function() {
        return a.asm._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_OCTAHEDRON_TRANSFORM
            .apply(null, arguments)
      },
      cd = a._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_QUANTIZATION_TRANSFORM =
          function() {
        return a.asm._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_QUANTIZATION_TRANSFORM
            .apply(null, arguments)
      },
      dd = a._emscripten_enum_draco_EncodedGeometryType_INVALID_GEOMETRY_TYPE = function() {
        return a.asm._emscripten_enum_draco_EncodedGeometryType_INVALID_GEOMETRY_TYPE.apply(
            null, arguments)
      }, ed = a._emscripten_enum_draco_EncodedGeometryType_POINT_CLOUD = function() {
        return a.asm._emscripten_enum_draco_EncodedGeometryType_POINT_CLOUD.apply(null, arguments)
      }, fd = a._emscripten_enum_draco_EncodedGeometryType_TRIANGULAR_MESH = function() {
        return a.asm._emscripten_enum_draco_EncodedGeometryType_TRIANGULAR_MESH.apply(
            null, arguments)
      }, gd = a._emscripten_enum_draco_GeometryAttribute_Type_COLOR = function() {
  ...
  var l = {
    ...
    alloc: function(b, c) {
      ...
      b = b + 7 & -8;
      l.pos + b >= l.size ? (f(0 < b), l.needed += b, c = a._malloc(b), l.temps.push(c)) :
  ...
  r.prototype.HasEntry = r.prototype.HasEntry = function(a, c) {
    ...
    l.prepare();
    a && 'object' === typeof a && (a = a.ptr);
    c = c && 'object' === typeof c ? c.ptr : ea(c);
    return !!Ec(b, a, c)
  };
  ...
  g.prototype.GetAttributeIdByMetadataEntry =
      g.prototype.GetAttributeIdByMetadataEntry = function(a, c, d) {
        var b = this.ptr;
        l.prepare();
        a && 'object' === typeof a && (a = a.ptr);
        c = c && 'object' === typeof c ? c.ptr : ea(c);
        d = d && 'object' === typeof d ? d.ptr : ea(d);
        return Jb(b, a, c, d)
      };
  ...
  g.prototype.GetAttributeFloat = g.prototype.GetAttributeFloat = function(a, c, d) {
    var b = this.ptr;
    a && 'object' === typeof a && (a = a.ptr);
    c && 'object' === typeof c && (c = c.ptr);
    d && 'object' === typeof d && (d = d.ptr);
  ...
  g.prototype.GetAttributeFloatForAllPoints =
      g.prototype.GetAttributeFloatForAllPoints = function(a, c, d) {
        var b = this.ptr;
        a && 'object' === typeof a && (a = a.ptr);
        c && 'object' === typeof c && (c = c.ptr);
        d && 'object' === typeof d && (d = d.ptr);
  ...
  g.prototype.GetAttributeInt8ForAllPoints =
      g.prototype.GetAttributeInt8ForAllPoints = function(a, c, d) {
        var b = this.ptr;
        a && 'object' === typeof a && (a = a.ptr);
        c && 'object' === typeof c && (c = c.ptr);
        d && 'object' === typeof d && (d = d.ptr);
  ...
  g.prototype.GetAttributeUInt8ForAllPoints =
      g.prototype.GetAttributeUInt8ForAllPoints = function(a, c, d) {
        var b = this.ptr;
        a && 'object' === typeof a && (a = a.ptr);
        c && 'object' === typeof c && (c = c.ptr);
        d && 'object' === typeof d && (d = d.ptr);
  ...
  g.prototype.GetAttributeInt16ForAllPoints =
      g.prototype.GetAttributeInt16ForAllPoints = function(a, c, d) {
        var b = this.ptr;
        a && 'object' === typeof a && (a = a.ptr);
        c && 'object' === typeof c && (c = c.ptr);
        d && 'object' === typeof d && (d = d.ptr);
  ...
  g.prototype.GetAttributeUInt16ForAllPoints =
      g.prototype.GetAttributeUInt16ForAllPoints = function(a, c, d) {
        var b = this.ptr;
        a && 'object' === typeof a && (a = a.ptr);
        c && 'object' === typeof c && (c = c.ptr);
        d && 'object' === typeof d && (d = d.ptr);
  ...
  g.prototype.GetAttributeInt32ForAllPoints =
      g.prototype.GetAttributeInt32ForAllPoints = function(a, c, d) {
        var b = this.ptr;
        a && 'object' === typeof a && (a = a.ptr);
        c && 'object' === typeof c && (c = c.ptr);
        d && 'object' === typeof d && (d = d.ptr);
  ...
  g.prototype.GetAttributeUInt32ForAllPoints =
      g.prototype.GetAttributeUInt32ForAllPoints = function(a, c, d) {
        var b = this.ptr;
        a && 'object' === typeof a && (a = a.ptr);
        c && 'object' === typeof c && (c = c.ptr);
        d && 'object' === typeof d && (d = d.ptr);
  ...
  (function() {
    function b() {
      ...
      a.ERROR = md();
      a.IO_ERROR = od();
      a.INVALID_PARAMETER = nd();
      a.UNSUPPORTED_VERSION = rd();
      a.UNKNOWN_VERSION = qd();
      a.INVALID_GEOMETRY_TYPE = dd();
      a.POINT_CLOUD = ed();
      a.TRIANGULAR_MESH = fd();
      a.ATTRIBUTE_INVALID_TRANSFORM = $c();
      a.ATTRIBUTE_NO_TRANSFORM = ad();
      a.ATTRIBUTE_QUANTIZATION_TRANSFORM = cd();
