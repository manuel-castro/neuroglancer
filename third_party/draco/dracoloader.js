...
//     promise = DRACOLoader._loadScript( path + 'draco_wasm_wrapper_unmin.js' )
//         .then( function () {
...
import DracoDecoderModule from "draco_wasm_wrapper.exec.js";
require('draco_decoder.wasm');

// this.dracoModule = DracoDecoderModule();
...
//     const that = this;
//     this.dracoDecoderType['onModuleLoaded'] = () => {
//         // Create the decoder instance
//         that.dracoDecoder = new that.dracoModule.Decoder();
//         that.moduleLoaded = true;
//     };
//     this.decoderModule = DracoDecoderModule(this.dracoDecoderType);
// })();
...
//   if (typeof DRACOLoader.dracoDecoderType === 'undefined')
//     DRACOLoader.dracoDecoderType = {};
...
function loadDracoDecoder() {
  if (typeof WebAssembly !== 'object') {
    ...
    loadJavaScriptFile('draco_decoder.js', createDecoderModule);
  } else {
    // loadJavaScriptFile('draco_wasm_wrapper_unmin.js', loadWebAssemblyDecoder);
  }
}

loadWebAssemblyDecoder();

class GetDracoLoader {
    constructor() {
        return DracoLoader;
    }
}
